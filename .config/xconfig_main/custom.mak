...
linker.cmd: package/cfg/main_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/main_pem4fcfg.cmd\)\"$""\"C:/Users/Christopher/Desktop/CCS_Code/embedded_Program/embedded_Program/.config/xconfig_main/\1\""' package/cfg/main_pem4f.xdl > $@
